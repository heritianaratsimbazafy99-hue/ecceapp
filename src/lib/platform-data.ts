...
import {
  ...
  buildLatestContentProgressMaps,
  getContentCompletedAt,
  getContentProgressForAssignment,
  getEngagementBandLabel,
  isContentCompleted,
  type EngagementBand,
...
import {
  ...
  getLearnerProgramLaneLabel,
  getLearnerProgramLaneTone,
  getLearnerProgressLaneLabel,
  getLearnerProgressLaneTone,
  getMessageLaneMeta,
  getProgramProgressTone,
  ...
  isAgendaLane,
  isAgendaScope,
  isLearnerProgramLane,
  isLearnerProgressLane,
  type AdminProgramLane,
  type AgendaLane,
  type AgendaScope,
  type BadgeTone,
  type LearnerProgramLane,
